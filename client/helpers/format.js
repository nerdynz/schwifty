...
function fmtMax (str, maxLen, eli) {
  eli = eli + ''
  str = str + ''
  if (str.length > maxLen) {
    return str.substr(0, maxLen) + eli
  }
  return str
}
...
function fmtHtmlFromPlain (text) {
  return text.split('\n').join('</br>')
}
...
export { fmtTimeAgo, titleCase, splitTitleCase, fmtDate, fmtCost, fmtCamel, fmtKebab, fmtTextFromNum, fmtTime, fmtDateTime, fmtUtcDateTimez, fmtUpperCaseFirstLetter, truncate, fmtMax, fmtAttachment, fmtHtmlFromPlain }
